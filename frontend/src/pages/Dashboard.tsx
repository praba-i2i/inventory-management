...
import { itemsApi, categoriesApi, productsApi, inventoryApi, purchaseOrdersApi, stockAlertsApi } from '../services/api';
    ...
    const fetchData = async () => {
      try {
        ...
        setStats({
          ...
          totalInventoryItems: inventorySummary.total_items,
          totalPurchaseOrders: purchaseOrdersData.length,
          activeAlerts: alertsData.length,
          inventoryValue: inventorySummary.total_value,
          lowStockItems: inventorySummary.low_stock_items,
          outOfStockItems: inventorySummary.out_of_stock_items,
        });
      } catch (error) {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">${typeof stats.inventoryValue === 'number' ? stats.inventoryValue.toFixed(2) : '0.00'}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.totalPurchaseOrders}</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link to="/products" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
        ...
        <Link to="/inventory" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
        ...
        <Link to="/purchase-orders" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">Manage supplier orders</p>
            </div>
          </div>
        </Link>

        <Link to="/stock-alerts" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">Monitor stock alerts</p>
            </div>
          </div>
        </Link>

        <Link to="/suppliers" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
        ...
        <Link to="/categories" className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <div className="flex-shrink-0">
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Legacy Items</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              to="/items/new"
